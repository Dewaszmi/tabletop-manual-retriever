...
from tabletop_manual_retriever.config import QDRANT_COLLECTION, RAG_TOP_K
...
def _build_answer(sources: Sequence[RetrievedChunk]) -> str:
    if not sources:
        return "No relevant manual passages were found for that question."
